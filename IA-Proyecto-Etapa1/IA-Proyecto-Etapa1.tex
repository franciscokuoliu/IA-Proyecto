...
The benchmark results highlight a notable progression in classification capability across neural paradigms \cite{Jayanthi_Kavitha_2026}. Traditional recurrent networks, such as the standard LSTM, serve as the initial deep learning baseline with an accuracy of $84.0\%$, though they face difficulties when resolving fine-grained or overlapping affective categories \cite{Jayanthi_Kavitha_2026}. Transitioning to a bidirectional setup in BiLSTM enhances sequential representation by tracking context in both past and future steps, raising the accuracy to $87.0\%$ \cite{Jayanthi_Kavitha_2026}.
